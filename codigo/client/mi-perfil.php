...
// INICIO BLOQUE: ARRANQUE, LOGICA Y TOKEN CSRF DE MI PERFIL (CLIENT)
...
$pdo = Bd::getPdo();
// FIN BLOQUE: ARRANQUE, LOGICA Y TOKEN CSRF DE MI PERFIL (CLIENT)
...
<body class="tcgx-client-app" id="tcgx-client-app-root">
         ...
         <main class="tcgx-client-content" id="tcgx-client-main">
            ...
            <div class="tcgx-client-form-card">
               <form method="post" action="mi-perfil.php" id="tcgx-perfil-form" novalidate>
                  ...
                  <h3 class="tcgx-client-form-subtitle">Cambiar contraseña</h3>
                  <div class="row g-3">
                     <div class="col-12 col-md-4">
   ...
   <script src="vendor/js/mi-perfil.js?v=20260612a"></script>
</body>
</html>
