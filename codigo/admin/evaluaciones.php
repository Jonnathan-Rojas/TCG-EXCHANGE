...
// INICIO BLOQUE: ARRANQUE, LOGICA Y TOKEN CSRF DEL CRUD DE EVALUACIONES
require __DIR__ . '/includes/carga_sesion_admin.php';
require __DIR__ . '/includes/evaluaciones_logica.php';

// Token CSRF propio del CRUD de evaluaciones: independiente del token rotado por carga_sesion_admin,
...
// FIN BLOQUE: ARRANQUE, LOGICA Y TOKEN CSRF DEL CRUD DE EVALUACIONES
...
// Borrado fisico validado con el token propio del CRUD; patron PRG hacia el listado.
if (($_SERVER['REQUEST_METHOD'] ?? '') === 'POST' && isset($_POST['tcgx_evaluaciones_eliminar'])) {
    ...
    if ($tcgxEvaluacionesCsrf === '' || $tokenPost === '' || !hash_equals($tcgxEvaluacionesCsrf, $tokenPost)) {
        ...
        $resultadoEliminar = tcgx_evaluaciones_eliminar(Bd::getPdo(), (int) $idRaw, $idUsuarioVista);
...
$tcgxListaEvaluaciones = tcgx_evaluaciones_listar(Bd::getPdo());
      ...
      <div class="tcgx-admin-main">
         ...
         <main class="tcgx-admin-content" id="tcgx-admin-main">
            ...
            <div class="tcgx-admin-table-card">
               <table class="table table-hover align-middle tcgx-admin-dt-table" id="tcgx-tabla-evaluaciones">
                  <thead>
                     <tr>
                        <th>ID</th>
                        <th>Cliente</th>
                        ...
                        <tr>
                           ...
                           <td class="text-end">
                              <div class="tcgx-admin-actions justify-content-end">
                                 ...
                                 <!-- Eliminar (rojo/danger): borrado fisico con confirmacion. -->
