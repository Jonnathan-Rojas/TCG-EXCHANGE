...
// INICIO BLOQUE: PROCESAMIENTO POST DE ALTA DE INCIDENCIA
$tcgxFormValores = [];
$tcgxFormErrores = [];
...
if (($_SERVER['REQUEST_METHOD'] ?? '') === 'POST') {
    ...
    if ($tcgxIncCsrf === '' || $tokenPost === '' || !hash_equals($tcgxIncCsrf, $tokenPost)) {
        ...
        $validacion = tcgx_incidencias_validar_registro($pdo, $_POST);
...
// INICIO BLOQUE: CATALOGOS DEL FORMULARIO
$tcgxTiendasInc = tcgx_incidencias_listar_tiendas_reportadoras($pdo);
// FIN BLOQUE: CATALOGOS DEL FORMULARIO
            ...
            <section class="contenedor-central-sec">
               <div class="tcgx-admin-form-card">
                  <form method="post" action="incidencia-registrar.php" id="tcgx-inc-registrar-form" novalidate>
                     ...
                     <div class="tcgx-admin-form-actions mt-4">
