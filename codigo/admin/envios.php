...
// Token CSRF propio del modulo envios (independiente del token rotado por carga_sesion_admin).
...
$tcgxListaEnvios = tcgx_envios_listar(Bd::getPdo());
      ...
      <div class="tcgx-admin-main">
         ...
         <main class="tcgx-admin-content" id="tcgx-admin-main">
            ...
            <div class="tcgx-admin-table-card">
               <table class="table table-hover align-middle tcgx-admin-dt-table" id="tcgx-tabla-envios">
                  <thead>
                     <tr>
                        <th>Rastreo</th>
                        <th>Remitente</th>
                        ...
                        <tr>
                           ...
                           <td class="text-end">
                              <div class="tcgx-admin-actions justify-content-end">
                                 <!-- Ver (azul/primary): detalle, trazabilidad y acciones individuales, navegando por POST (sin GET con datos). -->
