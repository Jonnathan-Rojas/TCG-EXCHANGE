...
/**
 * Endpoint AJAX (solo POST) que alimenta el autocompletado Select2 del cliente a evaluar.
 * Busca clientes CLIENTE por nombre o cedula y devuelve JSON con el formato que espera Select2.
 * Seguridad: requiere sesion ADMINISTRADOR (carga_sesion_admin) y valida el token CSRF del modulo.
 * Sin metodo GET para el termino de busqueda (regla de seguridad del proyecto).
 */
...
// Solo POST y con el token propio del CRUD de evaluaciones (mismo que usan los formularios).
