...
// INICIO BLOQUE: ARRANQUE Y CONSULTA DE RESUMEN DEL PANEL TIENDA
require __DIR__ . '/includes/carga_sesion_store.php';
require __DIR__ . '/includes/store_dashboard_logica.php';

$tcgxDashboard = tcgx_store_dashboard_resumen(Bd::getPdo(), $idTiendaSesion);
$tcgxTotalEnvios = 0;
foreach ($tcgxDashboard['envios_por_estado'] as $filaEstado) {
    $tcgxTotalEnvios += (int) ($filaEstado['total'] ?? 0);
}
// FIN BLOQUE: ARRANQUE Y CONSULTA DE RESUMEN DEL PANEL TIENDA

$tcgxPageTitle = 'Tienda | TCG EXCHANGE';
   ...
   <div class="tcgx-store-app__body">
      ...
      <div class="tcgx-store-main">
         ...
         <main class="tcgx-store-content" id="tcgx-store-main">
            ...
            <!-- INICIO BLOQUE: KPIs OPERATIVOS DE LA TIENDA -->
            <div class="row g-3 mb-4 tcgx-store-kpi">
               <div class="col-12 col-md-6 col-xl">
                  <div class="card h-100">
                     <div class="card-body d-flex align-items-center justify-content-between">
                        <div>
                           <div class="tcgx-store-kpi__label">Incidencias abiertas</div>
                           <div class="tcgx-store-kpi__value"><?php echo $esc($tcgxDashboard['incidencias_abiertas']); ?></div>
                        </div>
                        <span class="tcgx-store-kpi__icon tcgx-store-kpi__icon--primary" aria-hidden="true"><i class="fa-solid fa-triangle-exclamation"></i></span>
                     </div>
                  </div>
               </div>
               <div class="col-12 col-md-6 col-xl">
                  <div class="card h-100">
                     <div class="card-body d-flex align-items-center justify-content-between">
                        <div>
                           <div class="tcgx-store-kpi__label">Envíos en origen</div>
                           <div class="tcgx-store-kpi__value"><?php echo $esc($tcgxDashboard['envios_origen']); ?></div>
                        </div>
                        <span class="tcgx-store-kpi__icon tcgx-store-kpi__icon--primary" aria-hidden="true"><i class="fa-solid fa-arrow-right-from-bracket"></i></span>
                     </div>
                  </div>
               </div>
               <div class="col-12 col-md-6 col-xl">
                  <div class="card h-100">
                     <div class="card-body d-flex align-items-center justify-content-between">
                        <div>
                           <div class="tcgx-store-kpi__label">Envíos en destino</div>
                           <div class="tcgx-store-kpi__value"><?php echo $esc($tcgxDashboard['envios_destino']); ?></div>
                        </div>
                        <span class="tcgx-store-kpi__icon tcgx-store-kpi__icon--dark" aria-hidden="true"><i class="fa-solid fa-arrow-right-to-bracket"></i></span>
                     </div>
                  </div>
               </div>
               <div class="col-12 col-md-6 col-xl">
                  <div class="card h-100">
                     <div class="card-body d-flex align-items-center justify-content-between">
                        <div>
                           <div class="tcgx-store-kpi__label">Consolidados activos</div>
                           <div class="tcgx-store-kpi__value"><?php echo $esc($tcgxDashboard['consolidados_activos']); ?></div>
                        </div>
                        <span class="tcgx-store-kpi__icon tcgx-store-kpi__icon--muted" aria-hidden="true"><i class="fa-solid fa-layer-group"></i></span>
                     </div>
                  </div>
               </div>
               <div class="col-12 col-md-6 col-xl">
                  <div class="card h-100">
                     <div class="card-body d-flex align-items-center justify-content-between">
                        <div>
                           <div class="tcgx-store-kpi__label">Evaluaciones</div>
                           <div class="tcgx-store-kpi__value"><?php echo $esc($tcgxDashboard['evaluaciones']); ?></div>
                        </div>
                        <span class="tcgx-store-kpi__icon tcgx-store-kpi__icon--primary" aria-hidden="true"><i class="fa-solid fa-star"></i></span>
                     </div>
                  </div>
               </div>
            </div>
            <!-- FIN BLOQUE: KPIs OPERATIVOS DE LA TIENDA -->

            <!-- INICIO BLOQUE: ENVIOS POR ESTADO (ACOTADO A LA TIENDA) -->
            <h2 class="tcgx-store-section-title">Envíos por estado</h2>
            <div class="tcgx-store-table-card mb-4">
               <table class="table table-hover align-middle tcgx-store-dt-table" id="tcgx-tabla-envios-estado">
                  <thead>
                     <tr>
                        <th>Estado</th>
            ...
            <!-- FIN BLOQUE: ENVIOS POR ESTADO (ACOTADO A LA TIENDA) -->
