...
$tcgxListaDevoluciones = tcgx_store_devoluciones_listar($pdo, $idTiendaSesion);
      ...
      <div class="tcgx-store-main">
         ...
         <main class="tcgx-store-content" id="tcgx-store-main">
            ...
            <div class="tcgx-store-table-card">
               <table class="table table-hover align-middle tcgx-store-dt-table" id="tcgx-tabla-devoluciones">
                  <thead>
                     <tr>
                        <th>Rastreo</th>
                        <th>Remitente</th>
