...
/**
 * Endpoint AJAX (solo POST) para el autocompletado Select2 del remitente/destinatario del envio (store).
 * Busca clientes (perfil CLIENTE) SOLO POR NOMBRE. Seguridad: sesion TIENDA + token CSRF del modulo envios.
 */
