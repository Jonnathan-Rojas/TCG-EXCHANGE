...
$tcgxListaConsolidados = tcgx_store_consolidados_listar($pdo, $idTiendaSesion);
   ...
   <div class="tcgx-store-app__body">
      ...
      <div class="tcgx-store-main">
         ...
         <main class="tcgx-store-content" id="tcgx-store-main">
            ...
            <!-- INICIO BLOQUE: BARRA DE ACCION DE ARMADO (TRAMO 1 EN TIENDA DE SESION) -->
            ...
            <div class="tcgx-store-table-card">
               <table class="table table-hover align-middle tcgx-store-dt-table" id="tcgx-tabla-consolidados">
                  <thead>
                     <tr>
                        <th>Rastreo</th>
                        <th>Tramo</th>
