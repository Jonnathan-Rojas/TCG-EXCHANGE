...
/**
 * Endpoint AJAX (solo POST) que alimenta el autocompletado Select2 del cliente a evaluar (modulo store).
 * Busca clientes CLIENTE por nombre o cedula y devuelve JSON con el formato que espera Select2.
 * Seguridad: requiere sesion TIENDA (carga_sesion_store) y valida el token CSRF del modulo de evaluaciones.
 */
