...
$tcgxListaIncidencias = tcgx_store_incidencias_listar($pdo, $idTiendaSesion);
      ...
      <div class="tcgx-store-main">
         ...
         <main class="tcgx-store-content" id="tcgx-store-main">
            ...
            <div class="tcgx-store-table-card">
               <table class="table table-hover align-middle tcgx-store-dt-table" id="tcgx-tabla-incidencias">
                  <thead>
                     <tr>
                        <th>ID</th>
                        <th>Envío</th>
