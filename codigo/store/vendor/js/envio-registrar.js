/**
 * Formulario de REGISTRO DE ENVIO INDIVIDUAL (store).
...
(function () {
	...
	// En store el origen es fijo: hidden #envio-origen-hidden; en admin era select #envio-origen.
	var selOrigen = document.getElementById('envio-origen-hidden') || document.getElementById('envio-origen');
	...
	// Origen fijo en store: no hay evento change; precio inicial al cargar.
	if (selOrigen && selOrigen.tagName === 'SELECT') {
