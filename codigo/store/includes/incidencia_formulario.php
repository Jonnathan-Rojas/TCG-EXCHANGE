...
/**
 * Parcial de campos del formulario de registro de incidencia (store).
 * Tienda reportadora fija a la tienda de sesion (hidden + readonly).
 *
 * Variables requeridas: $tcgxFormValores, $idTiendaSesion, $tcgxStoreNombreTienda.
 */
...
<div class="row g-3">
   ...
   <div class="col-12 col-md-4">
      ...
      <input type="text" class="form-control" id="inc-tienda" value="<?php echo htmlspecialchars($tcgxStoreNombreTienda, ENT_QUOTES, 'UTF-8'); ?>" readonly>
   </div>
   <div class="col-12">
