...
// INICIO BLOQUE: ARRANQUE, LOGICA Y TOKEN CSRF DEL MODULO INCIDENCIAS (CD)
require __DIR__ . '/includes/carga_sesion_cd.php';
require __DIR__ . '/includes/cd_incidencias_logica.php';
...
$pdo = Bd::getPdo();
// FIN BLOQUE: ARRANQUE, LOGICA Y TOKEN CSRF DEL MODULO INCIDENCIAS (CD)
...
$tcgxInc = $idIncidencia > 0 ? tcgx_cd_incidencias_obtener($pdo, $idIncidencia, $idTiendaSesion) : null;
if ($tcgxInc === null) {
      ...
      <div class="tcgx-cd-main">
         ...
         <main class="tcgx-cd-content" id="tcgx-cd-main">
            ...
            <div class="tcgx-cd-table-card mb-3">
               ...
               <?php else: ?>
                  <table class="table table-hover align-middle tcgx-cd-dt-table" id="tcgx-tabla-historial">
                     <thead>
                        <tr>
                           <th>Fecha</th>
                           <th>Estado</th>
