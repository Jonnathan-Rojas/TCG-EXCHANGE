...
require_once __DIR__ . '/includes/cd_envios_logica.php';

// Token CSRF propio del modulo envios (misma clave que admin; independiente del token rotado por carga_sesion_cd).
...
$tcgxListaEnvios = tcgx_cd_envios_listar(Bd::getPdo(), $idTiendaSesion);
      ...
      <div class="tcgx-cd-main">
         ...
         <main class="tcgx-cd-content" id="tcgx-cd-main">
            ...
            <div class="tcgx-cd-table-card">
               <table class="table table-hover align-middle tcgx-cd-dt-table" id="tcgx-tabla-envios">
                  <thead>
                     <tr>
                        <th>Rastreo</th>
                        <th>Remitente</th>
