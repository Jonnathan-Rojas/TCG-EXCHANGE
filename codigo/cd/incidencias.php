...
$tcgxListaIncidencias = tcgx_cd_incidencias_listar($pdo, $idTiendaSesion);
      ...
      <div class="tcgx-cd-main">
         ...
         <main class="tcgx-cd-content" id="tcgx-cd-main">
            ...
            <div class="tcgx-cd-table-card">
               <table class="table table-hover align-middle tcgx-cd-dt-table" id="tcgx-tabla-incidencias">
                  <thead>
                     <tr>
                        <th>ID</th>
                        <th>Envío</th>
