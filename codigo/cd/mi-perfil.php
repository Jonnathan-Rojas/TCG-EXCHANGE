...
// INICIO BLOQUE: ARRANQUE, LOGICA Y TOKEN CSRF DE MI PERFIL (CD)
...
$pdo = Bd::getPdo();
// FIN BLOQUE: ARRANQUE, LOGICA Y TOKEN CSRF DE MI PERFIL (CD)
         ...
         <main class="tcgx-cd-content" id="tcgx-cd-main">
            ...
            <div class="tcgx-cd-form-card">
               <form method="post" action="mi-perfil.php" id="tcgx-perfil-form" novalidate>
                  ...
                  <h3 class="tcgx-cd-form-subtitle">Cambiar contraseña</h3>
                  <div class="row g-3">
                     <div class="col-12 col-md-4">
