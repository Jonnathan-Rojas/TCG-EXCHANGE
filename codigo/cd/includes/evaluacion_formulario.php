...
/**
 * Parcial de campos del formulario de evaluacion (cd): tienda fijada por sesion (campo oculto).
 ...
 * - $idTiendaSesion (int): identificador de la tienda emisora (sesion cd).
 */
...
?>
<!-- INICIO BLOQUE: CAMPOS DEL FORMULARIO DE EVALUACION (CD) -->
<div class="row g-3">
   ...
   <!-- Cliente evaluado: busqueda dinamica Select2 + AJAX POST al endpoint del modulo cd. -->
...
<!-- FIN BLOQUE: CAMPOS DEL FORMULARIO DE EVALUACION (CD) -->
