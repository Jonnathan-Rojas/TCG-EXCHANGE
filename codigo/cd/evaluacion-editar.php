...
// INICIO BLOQUE: ARRANQUE, LOGICA Y TOKEN CSRF (CD)
...
$pdo = Bd::getPdo();
// FIN BLOQUE: ARRANQUE, LOGICA Y TOKEN CSRF (CD)


// INICIO BLOQUE: RESOLUCION DE OBJETIVO Y FLUJO (APERTURA / GUARDADO ACOTADO A TIENDA)
$tcgxFormErrores = [];
$tcgxFormValores = [];
...
$evaluacionActual = tcgx_cd_evaluaciones_obtener($pdo, $idObjetivo, $idTiendaSesion);
...
if ($esGuardar) {
    ...
    if ($errorRevalidacion !== null) {
        ...
        $validacion = tcgx_cd_evaluaciones_validar($pdo, $_POST, $idTiendaSesion);
...
// FIN BLOQUE: RESOLUCION DE OBJETIVO Y FLUJO (APERTURA / GUARDADO ACOTADO A TIENDA)
